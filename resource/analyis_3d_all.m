...
for name = name_list
    ...
    plot3(model_x, model_y, model_z, LineWidth=2, DisplayName='Model trajectory')

    hold on

    user_x = user(index_list_1(1):index_list_2(1)-back, 1);
    user_y = user(index_list_1(1):index_list_2(1)-back, 3);
    user_z = user(index_list_1(1):index_list_2(1)-back, 2);
    ...
    plot3(user_x, user_y, user_z, LineWidth=2, DisplayName='Model trajectory')
