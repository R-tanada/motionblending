...
# ----- Initial Position and Rotation ----- #
    ...
    # ----- Minimum limitation ----- #
    __minX, __minY, __minZ          = 200, -300, 120
    ...
    def TransformwithLPF(self, posMagnification = 1, rotMagnification = 1, isLimit = True, isOnlyPosition = True):
        """
        Calculate the position and rotation to be sent to xArm.
        ...
        x, y, z             = self.posfilt[0] * posMagnification + self.__initX, self.posfilt[1] * posMagnification + self.__initY, self.posfilt[2] * posMagnification + self.__initZ
        roll, pitch, yaw    = self.posfilt[3] * rotMagnification + self.__initRoll, self.posfilt[4] * rotMagnification + self.__initPitch, self.posfilt[5] * rotMagnification + self.__initYaw
