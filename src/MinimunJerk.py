...
class MinimumJerk:
    def __init__(self, Target: list, xArmConfig: dict, Threshold=300) -> None:
        ...
        self.recorder = DataRecordManager(header = ['t_0', 't_f', 'x_0', 'x_f', 't_p'], fileName='personal/params')
        ...
        if self.mode != 1:
            ...
            if self.flag == True:
                ...
                if diff_init >= self.initThreshold:
                    ...
                    self.recorder.record([0, self.tf, self.x0, self.target[self.target_index]["position"], self.elaspedTime])
